...
console.log(
  inventors.reduce((total, curr) => { return total + curr.passed - curr.year }, 0)
)
...
const boulevards = [...document.querySelectorAll('.mw-category-group li a')]
...
console.log(
  people.sort((a, b) => a.split(', ')[1] > b.split(', ')[1] ? 1 : -1)
)
